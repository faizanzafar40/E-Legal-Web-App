<?php
	...
	// Submitting the "Ask Question" box posts a new question to the board
	// under the signed-in client's username.
	if (isset($_POST['blogs_post'])) {
		$stmt = $db->prepare("INSERT INTO questions (title, post_date, post_time, client_name) VALUES (:title, '2017-01-10', '04:07:00', :client)");
		$ok = $stmt->execute(array(
			':title'  => $_POST['question'],
			':client' => $_SESSION["login_username"],
		));
