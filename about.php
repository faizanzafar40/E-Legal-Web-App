        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="single-member-progile mb-65 fix">
                        <div class="member-photo">
                            <img src="img/members/img-01.jpg" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="single-member-progile mb-65 fix">
                        <div class="member-photo">
                            <img src="img/members/img-02.jpg" alt="">
                        </div>
                        <div class="member-bio">
                            <h2>Bushra Ahsani</h2>
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="single-member-progile mb-65 fix">
                        <div class="member-photo">
                            <img src="img/members/img-03.jpg" alt="">
                        </div>
                        <div class="member-bio">
                            <h2>David Ramon</h2>
                            <span class="member-pos">Project Manager</span>
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="single-member-progile mb-65 fix">
                        <div class="member-photo">
                            <img src="img/members/img-04.jpg" alt="">
                        </div>
                        <div class="member-bio">
                            <h2>Jarhin Jones</h2>
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="single-member-progile mb-65 fix">
                        <div class="member-photo">
                            <img src="img/members/img-05.jpg" alt="">
                        </div>
                        <div class="member-bio">
                            <h2>Martin Adam</h2>
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="single-member-progile mb-65 fix">
                        <div class="member-photo">
                            <img src="img/members/img-06.jpg" alt="">
                        </div>
                        <div class="member-bio">
                            <h2>Jeniffer Aston</h2>
                            <span class="member-pos">Senior Developer</span>
                            <p>“Nam liber tempor cum soluta nobis eleifend option congue”</p>
                        </div>
                    </div>
                    <!-- /.End Of Single Member -->
    ...
    <section class="cta-area">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="cta-right">
                        <a href="#" class="button button-hover button-cta">get a free quote</a>
                    </div>
                </div>
            </div>
        </div>
