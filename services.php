            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-work">
                        <a class="work-thumb mb-35" href="single-services.php">
                            <img src="img/works/img-01.jpg" alt="">
                            <div class="work-hover"></div>
                        </a>
                        <div class="work-excerp">
                            <a href="single-services-1.php"><h2>Web Design</h2></a>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-work">
                        ...
                        <div class="work-excerp">
                            <a href="single-services-2.php"><h2>Graphic Design</h2></a>
                            <p>Duis autem vel eum iriure dolor in hendrerit in vulpu tate velit esse molestie consequat.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-work">
                        ...
                        <div class="work-excerp">
                            <a href="single-services-3.php"><h2>WordPress Customization</h2></a>
                            <p>Duis autem vel eum iriure dolor in hendrerit in vulpu tate velit esse molestie consequat.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-work">
                        <a class="work-thumb mb-35" href="img/works/img-04.jpg">
                            <img src="img/works/img-04.jpg" alt="">
                            <div class="work-hover"></div>
                        </a>
                        <div class="work-excerp">
                            <a href="single-services-4.php"><h2>Theme Development</h2></a>
                            <p>Duis autem vel eum iriure dolor in hendrerit in vulpu tate velit esse molestie consequat.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-work">
                        ...
                        <div class="work-excerp">
                            <a href="single-services-5.php"><h2>Plugin Development</h2></a>
                            <p>Duis autem vel eum iriure dolor in hendrerit in vulpu tate velit esse molestie consequat.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-work">
                        ...
                        <div class="work-excerp">
                            <a href="single-services-6.php"><h2>3D Design</h2></a>
                            <p>Duis autem vel eum iriure dolor in hendrerit in vulpu tate velit esse molestie consequat.</p>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from company.design360studios.com/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Dec 2016 21:10:41 GMT -->
</html>